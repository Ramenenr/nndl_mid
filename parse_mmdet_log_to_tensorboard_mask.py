...
if __name__ == '__main__':
    log_file = 'mmdetection/work_dirs/mask-rcnn_r50_fpn_1x_voc0712/20250528_154515/vis_data/20250528_154515.json'    # 替换成你的日志文件名
    tb_logdir = 'mmdetection/work_dirs/mask-rcnn_r50_fpn_1x_voc0712/20250528_154515/tensorboard_logs'    # TensorBoard日志存放目录
